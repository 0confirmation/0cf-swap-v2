...
export default class WalletStore {
	...
	constructor(store: ZeroStore) {
		// TODO: Add a network class to handle multichain
	...
	setZero = action(async (provider: any) => {
	...
	connect = action((wsOnboard: API) => {
		...
		console.log(walletState.wallet.provider);
		this.setZero(new ethers.providers.Web3Provider(walletState.wallet.provider));
	});
